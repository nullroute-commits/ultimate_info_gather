...
class SoftwareInfo:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "installed_packages_sample": [p.to_dict() for p in self.installed_packages[:50]],
            ...
            "system_services_sample": [s.to_dict() for s in self.system_services[:30]],
            "init_system": self.init_system,
            "containers": [c.to_dict() for c in self.containers],
            "container_runtimes": self.container_runtimes,
            "process_count": self.process_count,
            "running_processes_sample": [p.to_dict() for p in self.running_processes[:20]],
