...
class PlannerTests(unittest.TestCase):
    ...
    def test_bundle_writer_emits_expected_files(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertIn('timeout: 30m', orb_agent_config_text)
            ...
            self.assertIn("514:514/udp", compose_text)
            self.assertIn("514:514/tcp", compose_text)
            self.assertIn("601:601", compose_text)
